...
export class Backend implements backendInterface {
    ...
    async comparePrices(arg0: number, arg1: number): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getPriceWithDiscount(arg0: number, arg1: number): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceWithDiscount(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
